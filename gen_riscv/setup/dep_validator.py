...
Info
    Validator for the gen_riscv bundle dependencies.
'''
...
class GenRiscvBundleDependenciesValidator:
    '''
        Validator for the gen_riscv bundle dependencies.
    ...
    @classmethod
    def validate(cls, dependencies: GenRiscvBundleDependencies) -> None:
        '''
            Validates the gen_riscv bundle dependencies.

            :param dependencies: The gen_riscv bundle dependencies to be validated.
            :exceptions:
        ...
        '''
        ctx: str = 'gen_riscv_bundle_dependencies_validator::validate(...)'
        msg_dependencies_none: str = 'the gen_riscv bundle dependencies must be provided'
        msg_dependencies_istype: str = 'the gen_riscv bundle dependencies must be a Mapping'

        not_none(dependencies, ctx, msg_dependencies_none)
        istype(dependencies, Mapping, ctx, msg_dependencies_istype)

        for attr_name, expected_type in GenRiscvBundleKeys.get_dependency_to_type().items():
