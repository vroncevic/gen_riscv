...
Info
    A validator for the gen_riscv bundle.
'''
...
class GenRiscvBundleValidator:
    ...
    @classmethod
    def validate(cls, bundle: GenRiscvBundle) -> None:
        '''
            Validates the gen_riscv bundle.

            :param bundle: The gen_riscv bundle to be validated.
            :exceptions:
        ...
        '''
        ctx: str = 'gen_riscv_bundle_validator::validate(...)'
        msg_bundle_none: str = 'the gen_riscv bundle must be provided'
        msg_bundle_istype: str = 'the gen_riscv bundle must be an instance of GenRiscvBundle'
        ...
        istype(bundle, GenRiscvBundle, ctx, msg_bundle_istype)
