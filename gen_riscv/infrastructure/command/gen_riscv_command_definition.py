...
Info
    Defines GenRiscvCommandDefinition class.
'''
...
class GenRiscvCommandDefinition:
    '''
        CLI subcommand metadata definition for riscv project generation.
    ...
    def help_text(self) -> str:
        ...
        '''
        return 'Generate Riscv project skeleton'
