...
Info
    Defines GenRiscvCommandExecutor class.
'''
...
class GenRiscvCommandExecutor:
    '''
        Command executor strategy for generating riscv project files.
        ...
        It defines:
            ...
            :methods:
                ...
                | __str__ - Returns the GenRiscvCommandExecutor as string representation.
    '''
    ...
    def __str__(self) -> str:
        '''
            Returns the GenRiscvCommandExecutor as string representation.

            :return: The GenRiscvCommandExecutor as string representation.
        '''
        return to_str(self)
