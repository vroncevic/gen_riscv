...
from gen_riscv.infrastructure.cli.setup.options import CLIBundleOptions
from gen_riscv.infrastructure.cli.setup.opt_validator import CLIBundleOptionsValidator
from gen_riscv.infrastructure.cli.setup.bundle import CLIBundle
from gen_riscv.infrastructure.cli.setup.keys import CLIBundleKeys
...
from gen_riscv.infrastructure.command.icommand_definition import ICommandDefinition
from gen_riscv.infrastructure.command.icommand_executor import ICommandExecutor
...
class CLIBundleFactory:
    ...
    def create_bundle(cls, options: CLIBundleOptions) -> CLIBundle:
        ...
        service_definition: ICommandDefinition = GenRiscvCommandDefinition()
        service_executor: ICommandExecutor = GenRiscvCommandExecutor(definition=service_definition)
