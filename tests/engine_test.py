...
Module
    test_engine.py
Info
    Unit tests for GenRiscv engine.
'''
...
from gen_riscv.engine import GenRiscv
...
class TestGenRiscv(unittest.TestCase):
    ...
    def test_engine_process_success(self) -> None:
        ...
        mock_base = BaseBundleFactory.create_bundle(
            options=BaseBundleOptions(
                info_file='gen_riscv/infrastructure/config/gen_riscv.cfg',
                use_generator=True,
    ...
    @patch('gen_riscv.setup.validator.GenRiscvBundleValidator.validate')
    ...
    def test_cli_bundle_factory(self) -> None:
        from gen_riscv.infrastructure.cli.setup.factory import CLIBundleFactory
