...
Module
    validator_test.py
Info
    Unit tests for GenRiscvBundleValidator class.
'''
...
class TestGenRiscvBundleValidator(unittest.TestCase):
    ...
    def test_validate_bundle_none(self) -> None:
        with self.assertRaises(Exception):
            GenRiscvBundleValidator.validate(None)

    def test_validate_bundle_invalid_type(self) -> None:
        with self.assertRaises(Exception):
            GenRiscvBundleValidator.validate("invalid_bundle")
    ...
    def test_is_valid_success(self) -> None:
        ...
        self.assertTrue(GenRiscvBundleValidator.is_valid(bundle))

    def test_is_valid_failure(self) -> None:
        self.assertFalse(GenRiscvBundleValidator.is_valid(None))
        self.assertFalse(GenRiscvBundleValidator.is_valid("invalid"))
