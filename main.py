...
def main() -> bool:
    '''
        Bootstraps and runs the gen_riscv with required adapters.

        :return: True if successful, False otherwise.
        :exceptions: None
    '''
    gen_riscv: GenRiscv = GenRiscv(GenRiscvBundleFactory.create_bundle())

    return gen_riscv.process()


if __name__ == '__main__':
    '''
        Entry point for gen_riscv execution.
